"""Goal4 Diagnosis 的模型定义（独立副本，可自由修改）。
...
#: 本任务的分类头定义（仅 goal4_diagnosis 使用；多任务骨干会同时构建全部头，
#: 但训练时只对本任务那一路回传损失）
CLS_SPEC: list[tuple[str, int]] = [('TumorProbability', 1), ('Location', 15), ('Morphology', 3), ('WHO_Grade', 4), ('Enhancement', 1), ('EnhancementPattern', 8), ('Necrosis', 1), ('CysticChange', 1), ('Hemorrhage', 1), ('Calcification', 1), ('Margin', 1), ('Lobulation', 1), ('Signal_T2WI', 3), ('Signal_FLAIR', 3)]
